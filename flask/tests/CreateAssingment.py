...
class AdminTestCase(unittest.TestCase):
    ...
    def test_create_assignment_quiz(self):
        ...
        question_field = driver.find_element(By.ID, "question-input1")
        ...
        max_grade_field = driver.find_element(By.ID, "question-max-grade1")
        max_grade_field.send_keys("10")

        # Click the "Post Assignment" button
        post_assignment_button = driver.find_element(By.ID, "id=post-assignment-button")
