...
from ...flask.website.models  import db, User  # Import the database and the User model
...
class TestLoginPage(TestCase):
    def create_app(self):
        app = create_app(config_name='testing')  # Assume you have different configurations, including a 'testing' config
        return app
    ...
    def test_login_submission(self):
        ...
        with self.client:
            ...
            self.assert_redirects(response, '/dashboard')
